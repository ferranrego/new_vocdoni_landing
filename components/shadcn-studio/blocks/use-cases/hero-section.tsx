      ...
      <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
        <div className='mx-auto max-w-4xl text-center'>
          ...
          <MotionPreset
            ...
            transition={{ duration: 0.5 }}
          >
            From city councils to sports clubs, professional associations to political parties—discover how organizations worldwide leverage Vocdoni's secure, transparent, and verifiable digital voting platform to revolutionize governance and member engagement.
          </MotionPreset>
