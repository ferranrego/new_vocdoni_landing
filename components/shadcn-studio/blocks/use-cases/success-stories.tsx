import { ArrowRightIcon, CheckCircle2Icon, UsersIcon, ShieldCheckIcon, TrendingUpIcon } from 'lucide-react'
      ...
      <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
        ...
        <div className='mb-12 space-y-4 text-center sm:mb-16 lg:mb-20'>
          ...
          <MotionPreset
            ...
            transition={{ duration: 0.5 }}
          >
            Discover how leading organizations across industries have transformed their governance processes with Vocdoni's
                ...
                <div className='grid gap-6 lg:grid-cols-2'>
                  ...
                  <CardContent className='flex flex-col justify-center p-8 lg:order-1 lg:p-12'>
                    ...
                    <Button variant='outline' className='w-full sm:w-auto' asChild>
                      <a href={`#${story.id}`} className='inline-flex items-center gap-2'>
